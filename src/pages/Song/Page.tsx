...
export function Song(){
  ...
  usePageMeta({
    ...
    canonical: song ? `attikid.vercel.app/song/${song.slug}` : 'attikid.vercel.app/music',
    type: 'music.song',
