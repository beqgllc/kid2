...
export interface Album { id:string; title:string; artist_name:string; featured_artists:string|null; release_date:string; slug:string; description:string|null; cover_art_path:string|null; is_featured:boolean; created_at:string; updated_at:string; song_count?:number; cover_url?:string|null; }
export interface Song { id:string; album_id:string; title:string; artist_name:string; track_number:number|null; slug:string; audio_path:string; audio_mime_type:string|null; file_size:number|null; duration_seconds:number|null; release_date:string|null; is_featured:boolean; created_at:string; updated_at:string; album?:Album|null; artwork_url?:string|null; audio_url?:string|null; has_lyrics?:boolean; play_count?:number; like_count?:number; dislike_count?:number; comment_count?:number; }
